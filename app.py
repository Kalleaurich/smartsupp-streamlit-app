            ...
            with col:
                with st.container(border=True):
                    ...
                    if row["Supplement"] == "Creatine":
                        ...
                        protein_target_g = round(weight_kg * 2)
                        dosage_msg = (
                            "💡 Empfohlene Dosierung: Ca. 30-40g pro Portion (Ziel: ca. "
                            f"{protein_target_g}g Protein täglich bei {weight_kg}kg Körpergewicht, "
                            "d. h. insgesamt ca. 2g Protein pro kg Körpergewicht täglich)."
                        )
